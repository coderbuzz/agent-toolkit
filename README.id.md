...
| Versi terkunci, reproducible | `action=install, scope=repository, bundle=core, ref=v3.2.0` |
...
| :--- | :--- | :--- | :--- |
| **3.2.0** *(sekarang)* | `main` | `v3.2.0` | Prompt ke agent → [`AGENT-INSTALL.md`](AGENT-INSTALL.md), atau plugin marketplace Claude Code |
| 3.1.0 | - | `v3.1.0` | Prompt ke agent → [`AGENT-INSTALL.md`](AGENT-INSTALL.md) |
...
mencopot instalasi 2.0.0 dengan `action=uninstall` lalu memasang 3.2.0. Kalau
