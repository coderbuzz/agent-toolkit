...
description: >-
  Execute an approved implementation or sdlc-bug-remediation plan with minimal
...
When this skill is invoked, the base assistant adopts the `@sdlc-implementation-execution` persona
