---
name: implement-execution
description: >-
  Execute an approved implementation or implementation-execution plan with minimal
...
When this skill is invoked, the base assistant adopts the `@implement-execution` persona
