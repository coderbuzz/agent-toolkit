...
- No independent verification or sdlc-ship role owns macro validation
...
| `sdlc-product-manager-prd` | Rewrite | `sdlc-define-requirements` |
| `sdlc-clarification-analyst` | Rewrite | `sdlc-clarify` |
| `specification-architect` | Rewrite | `sdlc-design-spec` |
| `artifact-consistency-checker` | Rewrite | `sdlc-audit-coverage` |
| `planner-architect` | Rewrite | `sdlc-plan` |
| `god-mode-dev` | Replace | `sdlc-build` |
| `expert-sdlc-code-reviewer` | Rewrite | `sdlc-review-code` |
| `sdlc-fix-bug-architect` | Rewrite | `sdlc-fix-bug` |
| `diataxis-sdlc-documentation-architect` | Rewrite | `sdlc-document` |
| `memory-manager` | Retain and simplify | `sdlc-remember` |
| `karpathy-guidelines` | Merge | `sdlc-stay-on-rails` |
| `ponytail-lazy-senior-dev` | Merge | `sdlc-stay-on-rails` |
| `omni-dev` | Merge selective rules | `sdlc-stay-on-rails` |
| `grilling` | Merge | `sdlc-clarify` |
| `fable-protocol` | Replace | `sdlc-coordinate` |
...
- `sdlc-design-ui`
- `sdlc-handle-incident`
- `sdlc-add-observability`
- `sdlc-migrate-data`
